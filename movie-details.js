    ...
    if (starsInteractiveContainer) {
        ...
        stars.forEach((star, index) => {
            ...
            star.addEventListener('mousemove', function(event) {
                ...
                if (currentRatingDisplay) currentRatingDisplay.textContent = `${potentialUserRating.toFixed(1)} / 10.0`;
            });
            ...
            star.addEventListener('click', function() {
                ...
                if (currentRatingDisplay) currentRatingDisplay.textContent = `${selectedUserRating.toFixed(1)} / 10.0`;
        ...
        starsInteractiveContainer.addEventListener('mouseleave', function() {
            ...
            if (currentRatingDisplay) {
                currentRatingDisplay.textContent = selectedUserRating > 0 
                    ? `${selectedUserRating.toFixed(1)} / 10.0` 
